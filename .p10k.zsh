# Generated by Powerlevel10k configuration wizard on 2020-09-11 at 02:29 MST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 38309.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, round separators, round heads, blurred tails, 2 lines, solid, no frame,
# dark-ornaments, sparse, many icons, fluent, transient_prompt, instant_prompt=off.
